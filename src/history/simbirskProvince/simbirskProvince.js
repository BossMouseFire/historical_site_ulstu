export default function SimbirskProvince() {
  return (
    <div className="epochSelection">
      ...
      <p>
        В 1708 году вышел Указ Петра I о разделении Русского царства на 8
      ...
      <p>
        ...
        Петрович. По результатам реформ, проведенных Екатериной II, 11 сентября
        1780 года Синбирск переименован в Симбирск, а 15 сентября того же года
        из Симбирской провинции было образовано Симбирское наместничество.
      </p>
      <div className="photoContainer">
        ...
        <div className="photo">
          ...
          <p>
            Карта Симбирского наместничества, разделённая на 13 уездов (1792 г.)
          </p>
        </div>
      </div>
    </div>
